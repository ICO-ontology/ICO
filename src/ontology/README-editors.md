These notes are for the EDITORS of ico
...
Make sure you have an ID range in the [idranges file](ico-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [ico-edit.owl](ico-edit.owl)

** DO NOT EDIT ico.obo OR ico.owl in the top level directory **

[../../ico.owl](../../ico.owl) is the release version
 ...
 * [ico-idranges.owl](ico-idranges.owl)
...
This generates derived files such as ico.owl and ico.obo and places
...
what is in the `owl:versionIRI` of the derived ico.owl (`data-version` in
ico.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/ico.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ico/releases/YYYY-MM-DD.owl <-- change to the release you just made
